...
def webpage():
    ...
    <body>
    <ul>
        <li><form method="POST"><input name="defrag" type="hidden"/><button type="submit">defrag</button></form></li>
        ...
        <li><form method="POST"><input name="tetris" type="hidden"/><button type="submit">tetris</button></form></li>
    </ul>
    </body>
    </html>
    """
